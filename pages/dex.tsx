...
// Ваши мины/кошельки (как в стабильной версии)
...
// Jupiter mints — только для котировки
...
export default function HomeUI() {
    ...
    const handleConnect = useCallback(async () => {
        ...
        // стабильный двухарг. конструктор
    ...
    const fetchQuoteUsdcOut = useCallback(async (lamports: number): Promise<number | null> => {
        try {
            ...
            url.searchParams.set("amount", String(lamports)); // lamports
    ...
    const handleStakeViaQuote = useCallback(async () => {
        ...
        try {
            ...
            // Получаем «сколько USDC вышло бы»
            ...
            // Пересчёт в DLAN-юниты 1:1 к $ (с учётом decimals DLAN)
            ...
            alert(
                `Застейкано ${solNum} SOL.\nКурс Jupiter ≈ ${usdcFloat.toFixed(
                    6
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
                ...
                <Card>
                    ...
                    <p style={{ color: "#666", marginTop: 12 }}>
                        Внеесите SOL, получите DLAN  для получения ежденвных дивидендов.
                    </p>
